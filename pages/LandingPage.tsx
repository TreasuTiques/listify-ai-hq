...
const LandingPage: React.FC<LandingPageProps> = ({ onNavigate }) => {
  return (
    <div className="bg-white selection:bg-blue-100">
      ...
      <section className="py-10 sm:py-12 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <div className="rounded-[28px] border border-slate-200 bg-white shadow-sm px-6 sm:px-10 py-8 sm:py-10 text-center">
            ...
            {/* Additional mini testimonials (more legit feel) */}
            <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 text-left">
              <div className="rounded-2xl border border-slate-200 p-5 bg-white">
                <p className="text-sm font-semibold text-[#0F172A] leading-relaxed">
                  “Finally something that sounds like a real seller wrote it, not a robot. Titles come out searchable.”
                </p>
                <p className="text-xs text-slate-500 mt-2">
                  — Vintage toys & collectibles seller
                </p>
              </div>
              <div className="rounded-2xl border border-slate-200 p-5 bg-white">
                <p className="text-sm font-semibold text-[#0F172A] leading-relaxed">
                  “Copy, paste, done. No formatting fixes. That alone saves me a ton of time every week.”
                </p>
                <p className="text-xs text-slate-500 mt-2">
                  — Media/electronics reseller
                </p>
              </div>
              <div className="rounded-2xl border border-slate-200 p-5 bg-white">
                <p className="text-sm font-semibold text-[#0F172A] leading-relaxed">
                  “I list in bursts. This keeps my listings consistent so my store looks more pro.”
                </p>
                <p className="text-xs text-slate-500 mt-2">
            ...
            <button
              ...
              className="mt-8 bg-white text-slate-600 px-10 py-4 rounded-full text-lg font-semibold border border-slate-200 hover:bg-slate-50 transition"
            >
              Watch Demo
            </button>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl font-semibold text-[#0F172A] mb-3">
              Photos in. Listing out. Simple.
            </h3>
            <p className="text-slate-500 max-w-2xl mx-auto">
              Designed for the way resellers actually work: quick photos, fast edits, and batch listing.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-[28px] border border-slate-200 shadow-sm p-7">
              ...
              <p className="text-sm text-slate-500 mt-2">
                Use the same images you already take for eBay. No special setup.
              </p>
            </div>
            ...
            <div className="bg-white rounded-[28px] border border-slate-200 shadow-sm p-7">
              ...
              <p className="text-sm text-slate-500 mt-2">
                Pulls the important stuff buyers search for: brand, model, features, and condition language.
              </p>
            </div>
            ...
            <div className="bg-white rounded-[28px] border border-slate-200 shadow-sm p-7">
              ...
              <p className="text-sm text-slate-500 mt-2">
                Clean HTML sections that look professional and stay readable.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* ===================================================== */}
      {/* NEW SECTION — WHAT THIS IS / WHAT THIS IS NOT */}
      {/* ===================================================== */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="rounded-[28px] border border-slate-200 bg-white shadow-sm p-8">
              ...
              <ul className="space-y-3 text-slate-600">
                <li className="flex gap-3">
                  ...
                  <span>eBay-first listing output built for resellers (not generic AI text)</span>
                </li>
                <li className="flex gap-3">
                  <span className="mt-0.5">✅</span>
                  <span>Fast, batch-friendly workflow for storage units, estates, and backlog piles</span>
                </li>
                <li className="flex gap-3">
                  <span className="mt-0.5">✅</span>
                  <span>Clean, structured HTML that stays readable on mobile</span>
                </li>
              </ul>
            </div>
            ...
            <div className="rounded-[28px] border border-slate-200 bg-white shadow-sm p-8">
              ...
              <ul className="space-y-3 text-slate-600">
                <li className="flex gap-3">
                  <span className="mt-0.5">🚫</span>
                  <span>A generic chatbot that writes fluffy paragraphs</span>
                </li>
                <li className="flex gap-3">
                  <span className="mt-0.5">🚫</span>
                  <span>A dropshipping tool or “get rich quick” listing generator</span>
                </li>
                <li className="flex gap-3">
                  <span className="mt-0.5">🚫</span>
                  <span>A replacement for your photos, your sourcing, or your judgment</span>
                </li>
              </ul>
            </div>
          </div>

          {/* Light social proof (no fake numbers, no fake logos) */}
          <div className="mt-10 text-center">
            <div className="inline-flex flex-wrap justify-center gap-2">
              {[
                ...
                <span
                  key={tag}
                  className="px-4 py-2 rounded-full border border-slate-200 bg-slate-50 text-sm text-slate-600"
                >
                  {tag}
                </span>
              ))}
            ...
            <p className="text-sm text-slate-500 mt-4">
              Built around real reseller categories and real buyer search behavior.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* ===================================================== */}
      {/* NEW SECTION — FUTURE PROOF TEASER */}
      {/* ===================================================== */}
      <section className="py-14 sm:py-16 px-4 bg-slate-50">
        <div className="max-w-6xl mx-auto">
          <div className="rounded-[28px] border border-slate-200 bg-white shadow-sm p-8 sm:p-10 text-center">
            <div className="text-xs font-bold text-[#2563EB] uppercase tracking-[0.35em] mb-3">
              Future Proof
            </div>
            <h3 className="text-2xl font-semibold text-[#0F172A] mb-3">
              More reseller-only tools are coming.
            </h3>
            <p className="text-slate-500 max-w-2xl mx-auto">
              Think smarter batch workflows, better item specifics, and cleaner outputs across more categories —
              without adding more steps to your process.
            </p>
          </div>
        </div>
      </section>
