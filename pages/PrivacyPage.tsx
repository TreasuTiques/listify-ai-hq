  ...
  return (
    <div className="bg-white min-h-screen pb-32">
      ...
      <section className="pt-24 pb-16 px-4 text-center max-w-4xl mx-auto border-b border-slate-100">
        <div className="inline-block px-4 py-1.5 bg-slate-50 border border-slate-100 rounded-full text-slate-500 text-[10px] font-bold uppercase tracking-widest mb-4">
      ...
      <div className="max-w-3xl mx-auto px-4 mt-20 space-y-16">
        ...
        <section>
          <h2 className="text-2xl font-bold text-[#0F172A] mb-4 text-left">The Short Version</h2>
        ...
        <section className="space-y-6">
          <h2 className="text-2xl font-bold text-[#0F172A]">Information We Collect</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
              <h4 className="font-bold text-[#0F172A] mb-2">Account Info</h4>
              <p className="text-sm text-slate-500 leading-relaxed">Your name and email address so you can log in and save your work.</p>
            </div>
            <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
              <h4 className="font-bold text-[#0F172A] mb-2">Listing Content</h4>
              <p className="text-sm text-slate-500 leading-relaxed">The product photos you upload and the item details you type in.</p>
            </div>
            <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
              <h4 className="font-bold text-[#0F172A] mb-2">Usage Data</h4>
              <p className="text-sm text-slate-500 leading-relaxed">Basic info about how you use the app so we can fix bugs and make things faster.</p>
            </div>
            <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100">
              <h4 className="font-bold text-[#0F172A] mb-2">Support Messages</h4>
              <p className="text-sm text-slate-500 leading-relaxed">Any questions or feedback you send our way via email or chat.</p>
            </div>
          </div>
        </section>

        <section>
          <h2 className="text-2xl font-bold text-[#0F172A] mb-4">How We Use Your Info</h2>
        ...
        <section className="bg-[#0F172A] p-10 rounded-[32px] text-white">
        ...
        <section>
          <h2 className="text-2xl font-bold text-[#0F172A] mb-4 text-left">AI Processing Disclosure</h2>
          <p className="text-slate-600 leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-bold text-[#0F172A] mb-4 text-left">Your Rights & Control</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
        ...
        <section className="border-t border-slate-100 pt-16 text-center">
          <h2 className="text-2xl font-bold text-[#0F172A] mb-4">Questions?</h2>
          <p className="text-slate-500 mb-8">
            We are here to help. If you have any concerns about your privacy, just shoot us an email.
          </p>
          <a href="mailto:privacy@listifyaihq.com" className="text-[#2563EB] font-bold text-lg hover:underline underline-offset-4">
