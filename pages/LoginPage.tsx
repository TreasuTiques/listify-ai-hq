      ...
      <div className="max-w-md w-full bg-white rounded-[24px] shadow-xl border border-slate-200 p-8">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full bg-[#0F172A] text-white py-3.5 rounded-xl font-bold shadow-lg shadow-slate-900/10 hover:bg-blue-600 transition-all active:scale-95 disabled:opacity-70 flex justify-center items-center"
          >
        ...
        <div className="text-center mt-6">
          <p className="text-sm text-slate-500">
            ...
            <button type="button" onClick={() => onNavigate('/signup')} className="text-blue-600 font-bold hover:underline">
              Sign up
            </button>
          </p>
        </div>
