  ...
  return (
    <div className="bg-white min-h-screen pb-32 font-sans">
      ...
      <section className="pt-24 pb-16 px-4 text-center max-w-4xl mx-auto border-b border-slate-100">
        <div className="inline-block px-4 py-1.5 bg-blue-50 border border-blue-100 rounded-full text-blue-600 text-[10px] font-bold uppercase tracking-widest mb-4">
          Effective: May 2024
        </div>
      ...
      <div className="max-w-3xl mx-auto px-4 mt-20 space-y-20">
        ...
        {/* 1. Intro */}
        <section>
          <h2 className="text-2xl font-bold text-[#0F172A] mb-4">The Agreement</h2>
        ...
        {/* 2. Eligibility */}
        <section>
          <h2 className="text-2xl font-bold text-[#0F172A] mb-4 text-left">Who Can Use Listify</h2>
          <p className="text-slate-600 leading-relaxed">
        ...
        <section className="bg-slate-50 p-10 rounded-[32px] border border-slate-100">
          <h2 className="text-2xl font-bold text-[#0F172A] mb-6">Play Fair</h2>
          <p className="text-slate-600 mb-6">To keep the HQ running smoothly, you agree not to:</p>
          <ul className="space-y-4">
            <li className="flex gap-4 items-start">
              ...
              <p className="text-sm text-slate-600"><strong>Don't lie.</strong> Don't use our AI to create intentionally misleading listings or hide defects.</p>
            </li>
            <li className="flex gap-4 items-start">
              ...
              <p className="text-sm text-slate-600"><strong>Don't break the tech.</strong> No scraping, hacking, or trying to overload our servers.</p>
            </li>
            <li className="flex gap-4 items-start">
              ...
              <p className="text-sm text-slate-600"><strong>Don't steal.</strong> Only upload photos you own or have permission to use.</p>
            </li>
          </ul>
        </section>
        ...
        <section className="border-l-4 border-amber-400 pl-8">
          <h2 className="text-2xl font-bold text-[#0F172A] mb-4">The "Robot Assistant" Disclaimer</h2>
        ...
        {/* 5. Affiliation */}
        <section>
          <h2 className="text-2xl font-bold text-[#0F172A] mb-4">We Aren't eBay</h2>
          <p className="text-slate-600 leading-relaxed">
        ...
        {/* 6. Payments & Plans */}
        <section>
          <h2 className="text-2xl font-bold text-[#0F172A] mb-4">Subscriptions & Payments</h2>
          <p className="text-slate-600 leading-relaxed mb-4">
        ...
        <section>
          <h2 className="text-2xl font-bold text-[#0F172A] mb-4 text-left">What’s Yours & What’s Ours</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-6">
            <div className="p-6 border border-slate-100 rounded-2xl">
              <h4 className="font-bold text-[#0F172A] mb-2">Yours</h4>
              <p className="text-sm text-slate-500">You keep 100% ownership of your photos and your finished listing descriptions.</p>
            </div>
            <div className="p-6 border border-slate-100 rounded-2xl">
              <h4 className="font-bold text-[#0F172A] mb-2">Ours</h4>
              <p className="text-sm text-slate-500">We own the software, the logo, the code, and the specific AI workflows we built.</p>
            </div>
          </div>
        </section>
        ...
        <section>
          <h2 className="text-2xl font-bold text-[#0F172A] mb-4 text-left">The Legal Safety Net</h2>
        ...
        <section className="pt-16 border-t border-slate-100 text-center">
          <h2 className="text-2xl font-bold text-[#0F172A] mb-4">Still have questions?</h2>
          <p className="text-slate-500 mb-8">
            If something in here isn't clear, please reach out. We're happy to chat.
          </p>
          <a href="mailto:support@listifyaihq.com" className="bg-[#2563EB] text-white px-8 py-4 rounded-full font-bold hover:bg-blue-700 transition-all inline-block shadow-lg">
