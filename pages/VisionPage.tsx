  ...
  return (
    <div className="bg-white min-h-screen pb-32">
      ...
      <section className="pt-24 pb-16 px-4 text-center max-w-4xl mx-auto border-b border-slate-100">
        ...
        <p className="text-xl text-slate-500 leading-relaxed max-w-2xl mx-auto font-normal">
      ...
      <div className="max-w-4xl mx-auto px-4 mt-20 space-y-24">
        ...
        <section>
          <h2 className="text-3xl font-semibold text-[#0F172A] mb-6">Why We Built Listify AI HQ</h2>
          <div className="prose prose-slate lg:prose-lg text-slate-600 space-y-4">
            <p>
        ...
        <section className="bg-slate-50 p-10 md:p-16 rounded-[40px] border border-slate-100">
          <h2 className="text-3xl font-semibold text-[#0F172A] mb-8 text-center">Who We Serve</h2>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl font-semibold text-[#0F172A] mb-6">Our Philosophy</h2>
        ...
        <section className="border-t border-slate-100 pt-16">
          <h2 className="text-3xl font-semibold text-[#0F172A] mb-6">AI With Integrity</h2>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-16">
           <div>
              <h2 className="text-2xl font-semibold text-[#0F172A] mb-6">Our Commitment</h2>
           ...
           <div>
              <h2 className="text-2xl font-semibold text-[#0F172A] mb-6">Looking Ahead</h2>
