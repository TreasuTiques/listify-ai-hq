      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center gap-2 cursor-pointer group" onClick={() => onNavigate('/')}>
            <div className="w-9 h-9 bg-[#0F172A] dark:bg-blue-600 rounded-lg flex items-center justify-center text-white font-bold text-xl shadow-sm transition-all group-hover:scale-105">L</div>
          ...
          <div className="flex items-center gap-4">
             ...
             {/* 🌑 GLOBAL DARK MODE TOGGLE (High Visibility) */}
             <button 
               onClick={toggleTheme}
